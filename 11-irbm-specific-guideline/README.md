...
> ⚠️ **Unofficial transcription.** This markdown was auto-converted from the official PDF for developer convenience. Paragraph numbering, tables, and figures may differ from the original (the PDF has layout that does not cleanly translate to markdown — tables are preserved as pre-formatted text and references to figures remain as inline text pointers). **For any legal or compliance reference, use the official PDF** from the [IRBM e-Invoice portal](https://www.hasil.gov.my/en/e-invoice/).
...
- [3. Transactions with Buyers](#3-transactions-with-buyers)
- [4. Statements or Bills on a Periodic Basis](#4-statements-or-bills-on-a-periodic-basis)
- [5. Disbursement or Reimbursement](#5-disbursement-or-reimbursement)
- [6. Employment Perquisites and Benefits](#6-employment-perquisites-and-benefits)
- [7. Certain Expenses Incurred by Employee on Behalf of the Employer](#7-certain-expenses-incurred-by-employee-on-behalf-of-the-employer)
- [8. Self-Billed e-Invoice](#8-self-billed-e-invoice)
- [9. Transactions Involving Payments to Agents, Dealers or Distributors](#9-transactions-involving-payments-to-agents-dealers-or-distributors)
- [10. Cross Border Transactions](#10-cross-border-transactions)
- [11. Profit Distribution (e.g., Dividend Distribution)](#11-profit-distribution-eg-dividend-distribution)
- [12. Foreign Income](#12-foreign-income)
- [13. Currency Exchange Rate](#13-currency-exchange-rate)
...
- [Appendix 4 – Buyer's Details for Transaction with Individuals](#appendix-4-buyers-details-for-transaction-with-individuals)
- [Appendix 5 – General and Industry-Specific FAQ](#appendix-5-general-and-industry-specific-faq)
...
No       Data field       Details to be              Additional Remarks
included by
Supplier in
e-Invoice

1    Buyer’s Name      Name of individual      For Malaysian individuals: Full
Buyer                   name as per MyKad / MyTentera

For non-Malaysian individuals:
Full name as per passport / MyPR
/ MyKAS

2    Buyer’s TIN       TIN of individual       For Malaysian individuals
Buyer                   i. Option 1: TIN only
...
3    Buyer’s           Details of                passport number / MyPR /
Registration /    registration /            MyKAS identification number
Identification    identification
For clarity, (i) refers to the TIN
Number /          number / passport
...
4    Buyer’s Address      Address of              Individual Buyer is required to
individual Buyer        provide residential address

5    Buyer’s Contact      Telephone number Individual Buyer is required to
Number               of individual Buyer     provide a contact number

6    Buyer’s SST          SST registration        Where applicable, individual Buyer
Registration         number of               to provide SST registration number
Number               individual Buyer
...
1    Shipping             Name of individual      For Malaysian individuals
Recipient’s          Shipping Recipient      Full name as per MyKad /
Name                                         MyTentera
...
2    Shipping             Address of              Individual Shipping Recipient is
Recipient’s          individual Shipping     required to provide residential
Address              Recipient               address

3    Shipping             TIN of individual       For Malaysian individuals
Recipient’s TIN      Shipping Recipient        i. Option 1: TIN only
ii. Option 2: MyKad / MyTentera
identification number only
iii. Option 3: Both TIN and MyKad
/ MyTentera identification
4    Shipping             Details of
number
Recipient’s          registration /
Registration /       identification          For non-Malaysian individuals
Identification       number / passport       i.    Option 1: TIN only
Number /             number                  ii.   Option 2: Both TIN and
Passport                                           passport number / MyPR /
Number                                             MyKAS identification number
...
1    Option 1 (for         Buyer’s / Shipping      Supplier to input the TIN as
Malaysian and         Recipient’s TIN         provided by individual Buyer /
non-Malaysian                                 individual Shipping Recipient
individuals),
where the
...
individual Buyer /    Buyer’s / Shipping      Supplier to input “000000000000”
individual            Recipient's             in the e-Invoice
Shipping              Registration /
Recipient only        Identification
provides TIN          Number / Passport
Number

2       Option 2 (for         Buyer’s / Shipping      Supplier to input “EI00000000010”
Malaysian             Recipient's TIN         in the e-Invoice
individuals),
where the
individual Buyer /
individual
Buyer’s / Shipping      Supplier    to     input   MyKad       /
Shipping
Recipient's             MyTentera identification number
Recipient only
Registration /          provided by the individual Buyer /
provides MyKad
Identification          individual Shipping Recipient
/ MyTentera
Number / Passport
identification
Number
...
3    Supplier’s          Details of registration   Buyer to input “NA”
Registration /      / identification
Identification      number / passport
Number /            number
Passport Number

4    Supplier’s          Address of Supplier       Buyer to input “NA”
Address

5    Supplier’s          Telephone number of       Buyer to input “NA”
Contact Number      Supplier

6    Supplier’s SST      SST registration          Buyer to input “NA”
Registration        number of Supplier
Number

7    Supplier’s          MSIC code of              Buyer to input “00000”
Malaysia            Supplier (where
Standard            applicable)
Industrial
Classification
(MSIC code)

8    Supplier’s          Description of the        Buyer to input “NA”
Business Activity   Supplier’s business
...
in consolidated
self-billed e-Invoice
9    Classification   Classification of        Buyer to input a 3-digit integer
product or services      (e.g., “000” to “999”), in
accordance with the catalogue
set by IRBM

10   Description of   Details of products or   IRBM allows the Buyers to
Product /        services being billed    adopt one (or a combination) of
Services         for a transaction with   the following methods for the
Supplier                 consolidated                self-billed
e-Invoice:
...
IRBM will send notification to the Supplier only (i.e., no
notification will be sent to Buyer as this is an
...
3    Buyer’s             Details of registration   Supplier to input “NA”
Registration /      / identification
Identification      number / passport
Number /            number
Passport Number
...
5    Buyer’s Contact     Telephone number of       Supplier to input “NA”
Number              Buyer

6    Buyer’s SST         SST registration          Supplier to input “NA”
Registration        number of Buyer
Number

7    Description of      Details of products or    IRBM allows the Suppliers to
Product/ Services   services being billed     adopt one (or a combination) of
for a transaction with    the following methods:
Buyer
(a) Summary of each receipt is
presented as separate line
items
...
consolidated e-Invoice is not allowed
...
2         Aviation                •   Sale of flight ticket
•   Private charter

3         Luxury goods and Details will be released in due course
jewellery
...
5    Licensed betting      Pay-out to winners for all betting and gaming activities
and gaming
...
6    Payment to agents     Payments made to agents, dealers or distributors
/ dealers /
...
8    Electricity service   Distribution, supply or sale of electricity
provider
Note that this will be effective starting 1 January 2026,
...
3    Buyer’s          Details of registration
i. Option 1: TIN only
Registration /   / identification
ii. Option 2: MyKad / MyTentera
Identification   number / passport
...
4    Buyer’s        Address of Buyer           Supplier to input business
Address                                   address (for business) /
residential address (for
individual) of Buyer

5    Buyer’s        Telephone number of        Supplier to input contact number
Contact        Buyer                      of Buyer
Number

6    Buyer’s SST    SST registration           Where applicable, Supplier to input
Registration   number of Buyer            Buyer’s SST registration number
Number
...
7     e-Invoice             Reference number of        Supplier to input the reference
Code /                the statement issued       number of the statement / bill
Number                by Supplier to Buyer       issued to Buyer (e.g., business /
(e.g., business /          individual)
individual)
...
3    Buyer’s           Details of               Supplier to input “NA”
...
5    Buyer’s Contact   Telephone number         Supplier to input “NA”
Number            of Buyer
...
7    Description of    Details of products      IRBM allows the Suppliers to
Product /         or services being        adopt one (or a combination) of
Services          billed for as a result   the following methods:
of commercial
...
## 7. Certain Expenses Incurred by Employee on Behalf of the Employer
...
Step 2:   Where an e-Invoice can be issued to the employer, the
employees should provide the details of the employer in order
for the e-Invoice to be issued to the employer.
...
(e) Pay-out to all betting and gaming winners1
...
1 Pay-outs to winners in relation to betting and gaming (i) in casino and (ii) from gaming
...
treasury services to its related companies2; and
...
accordance with the following timing of issuance3:

If there is a written •    If no approval is required from the
agreement                  government or state government, the date
...
If there is no written •   Date of completion
agreement


2 Considering that taxpayers may require additional time to configure their systems,

taxpayers are allowed to implement this requirement latest by 1 July 2025.
3 Please note that the timing of issuance is only applicable for the transaction stated
...
Upon full implementation of e-Invoice on 1 July 2025, Mak Cik Rosa is
required to issue e-Invoice for all of her sales (either individual or
consolidated e-Invoice) and submit for IRBM’s validation.
...
1     Payment to agents,            Agents, dealers,        Taxpayer that makes the
dealers, distributors, etc     distributors, etc.             payment

2     Goods sold or services          Foreign Seller         Malaysian Purchaser
rendered by foreign
suppliers
3     Profit distribution (e.g.,     Recipient of the       Taxpayer that makes the
dividend distribution)            distribution               distribution

4     e-Commerce                    Merchant, service            e-Commerce /
providers           Intermediary platform
(e.g., driver, rider)

5     Pay-out to all betting and     Recipient of the        Licensed betting and
gaming winners                      pay-out               gaming provider

6     Transactions with               Individual not        Person transacting with
individuals who are not          conducting a            the individual not
conducting a business              business            conducting a business

7     Interest payment             Recipient of interest    Taxpayer that makes the
payment               interest payment

8     Claim, compensation or          Policyholder /                 Insurer
benefit payments from            Beneficiary
...
9     Payment in relation to                 Investor                        Investee
...
1     Option 1 (for            Supplier’s TIN         Buyer to input the TIN as provided
Malaysian and                                   by individual Supplier
non-Malaysian
individuals), where
...
the individual         Supplier’s             Buyer to input “000000000000” in
Supplier only          Registration /         the e-Invoice
provides TIN           Identification
Number /
Passport Number

2     Option 2 (for          Supplier’s TIN         Buyer to input “EI00000000010” in
Malaysian                                     the e-Invoice
individuals), where
the individual
Supplier only          Supplier’s             Buyer to input MyKad / MyTentera
provides MyKad /       Registration /         identification number provided by
MyTentera              Identification         the individual Supplier
identification         Number /
...
3    Supplier’s           Details of             For Malaysian Individuals
Registration /       registration /         i. Option 1: TIN only
Identification       identification         ii. Option 2: MyKad / MyTentera
Number / Passport    number / passport         identification number only
Number               number                 iii. Option 3: Both TIN and MyKad /
...
4    Supplier’s Address   Address of             Buyer to input the business address
Supplier               (for business) / residential
...
5    Supplier’s Contact   Telephone            Buyer to input the contact number
Number               number of            of Supplier
Supplier

6    Supplier’s SST       SST registration     Where applicable, Buyer to input
Registration         number of            Supplier’s SST registration number
Number               Supplier
Where Supplier is not registered for
SST, Buyer to input “NA”

7    Supplier’s           MSIC code of         Where applicable, Buyer to input
Malaysia Standard    Supplier (where      Supplier’s MSIC code
...
8    Supplier’s           Description of the   Where applicable, Buyer to input
Business Activity    Supplier’s           Supplier’s Business Activity
...
9    Classification       Classification of    Buyer to input a 3-digit integer (e.g.,
products or          “000” to “999”), in accordance with
services             the catalogue set by IRBM
...
10   e-Invoice Code /       Document               Reference number of the invoice /
Number                 reference number       bill / receipt issued by the Supplier
used by Supplier       (if applicable)
for internal
tracking purposes
...
## 9. Transactions Involving Payments to Agents, Dealers or Distributors
...
1    Supplier’s Name Name of Agent /              For Business: Name of
Dealer / Distributor      business
...
2    Supplier’s TIN     TIN of Agent / Dealer     For Malaysian Businesses
/ Distributor             Seller to input Agent / Dealer /
...
3    Supplier’s       Details of registration   TIN and business registration
...
4    Supplier’s       Address of Agent /       Seller to input the business
Address          Dealer / Distributor     address (for business) /
residential address (for
individual) of Agent / Dealer /
Distributor

5    Supplier’s       Telephone number of      Seller to input the contact
Contact Number the Agent / Dealer /       number of Agent / Dealer /
Distributor              Distributor


6    Supplier’s SST   SST registration         Where applicable, Seller to input
Registration     number of the Agent      Agent / Dealer / Distributor’s SST
Number           / Dealer / Distributor   registration number
...
7     Supplier’s            MSIC code of the            Where applicable, Seller to input
Malaysia              Agent / Dealer /            Agent / Dealer / Distributor’s
Standard              Distributor                 MSIC code
Industrial
...
8     Supplier’s            Description of the          Where applicable, Seller to input
Business              Agent / Dealer /            Agent / Dealer / Distributor’s
Activity              Distributor’s business Business Activity Description
Description           activity
Seller to input “NA” if such
information is not available or not
provided

9     Classification        Classification of           Seller to input a 3-digit integer
products or services        (e.g., “000” to “999”), in
accordance with the catalogue
set by IRBM

10     e-Invoice Code / Document reference               Reference number of the receipt
Number                number used by              issued by the Seller
Seller for internal
tracking purposes
...
**10.3** Cross-border transactions consist of the following:
...
1    Supplier’s Name   Name of Foreign          For Business: Name of business
Seller
...
3    Supplier’s       Details of registration   Malaysian Purchaser to input
Registration /   / identification          business registration / passport
Identification   number / passport         number / MyPR / MyKAS
Number /         number                    identification number of Foreign
Passport                                   Seller
Number
...
4    Supplier’s       Address of Foreign        Malaysian Purchaser to input
Address          Seller                    business address (for business) /
residential address (for
individual) of the Foreign Seller

5    Supplier’s       Telephone number of       Malaysian Purchaser to input the
Contact Number   Foreign Seller            contact number of Foreign Seller

6    Supplier’s SST   SST registration          Where applicable, Malaysian
Registration     number of the             Purchaser to input Foreign Seller’s
Number           Foreign Seller            SST registration number
...
7    Supplier’s           MSIC code of               Where applicable, Malaysian
Malaysia             Foreign Seller             Purchaser to input Foreign Seller’s
Standard                                        MSIC code
Industrial
Malaysian Purchaser to input
Classification                                  “00000” if such information is not
(MSIC code)                                     applicable, not available or not
provided

8    Supplier’s           Description of the         Where applicable, Malaysian
Business             Foreign Seller’s           Purchaser to input Foreign Seller’s
Activity             business activity          Business Activity Description
Description                                     Malaysian Purchaser to input “NA”
if such information is not applicable,
not available or not provided

9    Classification       Classification of          Malaysian Purchaser to input a 3-
products or services       digit integer (e.g., “000” to “999”), in
...
No      Data field       Details to be input by         Additional Remarks
Malaysian Seller in an
e-Invoice
1    Buyer’s Name       Name of Foreign             For business: Name of
Purchaser                   business
...
2    Buyer’s TIN        TIN of Foreign              Malaysian Seller to input the
Purchaser                   Foreign Purchaser’s TIN,
where available
...
3    Buyer’s            Details of registration /   Where available, Malaysian
Registration /     identification number /     Seller to input the business
Identification     passport number             registration / passport number
Number /                                       / MyPR / MyKAS identification
Passport                                       number of Foreign Purchaser
Number
...
Malaysian Seller in an
e-Invoice
4      Buyer’s Address Address of Foreign                Malaysian Seller to input the
Purchaser                     business address (for
business) / residential
address (for individual) of
Foreign Purchaser

5      Buyer’s Contact     Telephone number of           Malaysian Seller to input the
Number              Foreign Purchaser             contact number of Foreign
Purchaser

6      Buyer’s SST         SST registration              Where applicable, Malaysian
Registration        number of the Foreign         Seller to input Foreign
Number              Purchaser                     Purchaser’s SST registration
number
...
2    Supplier’s TIN    TIN of Recipient        For Malaysian Businesses
...
3    Supplier’s        Details of registration    Where TIN is not available or not
Registration /    / identification           provided, taxpayer that makes
Identification    number / passport          the distribution to input
Number /          number                     “EI00000000030” for Foreign
Passport Number                              Recipient
...
4    Supplier’s       Address of Recipient    Taxpayer that makes the
Address                                  distribution to input business
address (for business) /
residential address (for
individual) of the Recipient

5    Supplier’s       Telephone number of     Taxpayer that makes the
Contact Number   Recipient               distribution to input the contact
number of Recipient
...
6    Supplier’s SST        SST registration            Where applicable, taxpayer that
Registration          number of Recipient         makes the distribution to input
Number                                            Recipient’s SST registration
number
...
7    Classification        Classification of           Taxpayer that makes the
products or services        distribution to input a 3-digit
integer (e.g., “000” to “999”), in
accordance with the catalogue
set by IRBM

8    e-Invoice Code /      Document reference          Reference number of the
Number                number used by the          dividend voucher issued by the
taxpayer that makes         taxpayer that makes the
...
3    Buyer’s           Details of registration /   Where available, Income
Registration /    identification number /     Recipient to input the
Identification    passport number             registration / passport number /
Number /                                      MyPR / MyKAS identification
Passport                                      number of Payor
Number
...
5    Buyer’s Contact   Telephone number of         Income Recipient to input the
Number            Payor                       contact number of Payor

No        Data field       Details to be included            Additional Remarks
by Income Recipient
in an e-Invoice
6    Buyer’s SST          SST registration            Where applicable, Income
Registration         number of Payor             Recipient to input Payor’s SST
...
platform provider
in an e-Invoice
1    Buyer’s Name         Name of              For business: Name of business
Purchaser
For Malaysian individuals: Full
name as per MyKad / MyTentera
...
2    Buyer’s TIN          TIN of               For Malaysian Businesses
Purchaser            e-commerce platform provider to
...
platform provider
in an e-Invoice
3    Buyer’s           Details of             provider to input “EI00000000020”
Registration /    registration /         for Foreign Businesses
Identification    identification
Where business registration
Number /          number / passport
number is not available or not
...
4    Buyer’s Address       Address of              e-commerce platform provider to
Purchaser               input business address (for
business) / residential address
(for individual) of the Purchaser

5    Buyer’s Contact       Telephone number e-commerce platform provider to
Number                of Purchaser            input contact number of the
Purchaser

6    Buyer’s SST           SST registration        Where applicable, e-commerce
Registration          number of               platform provider to input
Number                Purchaser               Purchaser’s SST registration
number
...
7    Classification        Classification of       e-commerce platform provider to
products or             input a 3-digit integer (e.g., “000” to
services                “999”), in accordance with the
...
1     Supplier’s Name     Name of Merchant       For Business: Name of business
and/or Service
For Malaysian individuals: Full
Provider
name as per MyKad / MyTentera
...
2     Supplier’s TIN    TIN of Merchant        For Malaysian Business
and/or Service         e-commerce platform provider to
Provider               input Merchant and/or Service
...
3     Supplier’s        Details of             Provider
Registration /    registration /
Identification    identification         Where business registration

Number /          number / passport      number is not available or not

Passport Number   number                 provided, e-commerce platform
provider to input “NA”
...
4     Supplier’s       Address of            e-commerce platform provider to
Address          Merchant and/or       input the business address (for
Service Provider      business) / residential address
...
5     Supplier’s       Telephone number e-commerce platform provider to
Contact Number   of Merchant and/or input the contact number of
Service Provider      Merchant and/or Service Provider


6     Supplier’s SST   SST registration      Where applicable, e-commerce
Registration     number of             platform provider to input Merchant
Number           Merchant and/or       and/or Service Provider’s SST
...
7     Supplier’s       MSIC code of          Where applicable, e-commerce
Malaysia         Merchant and/or       platform provider to input Merchant
Standard         Service Provider      and/or Service Provider’s MSIC
Industrial                             code
Classification
e-commerce platform provider to
(MSIC code)
...
1    Buyer’s Name       Name of Merchant       For Business: Name of business
and/or Service
For Malaysian individuals: Full
Provider
name as per MyKad / MyTentera
...
2    Buyer’s TIN        TIN of Merchant        For Malaysian Business
and/or Service         e-commerce platform provider to
Provider               input Merchant and/or Service
Provider’s TIN
...
3    Buyer’s          Details of              For Malaysian Individuals
Registration /   registration /            i.    Option 1: TIN only
Identification   identification           ii.    Option 2: MyKad / MyTentera
Number /         number / passport               identification number only
Passport         number                   iii.   Option 3: Both TIN and MyKad
Number                                           / MyTentera identification
number
...
4    Buyer’s          Address of              E-commerce platform provider to
Address          Merchant and/or         input the business address (for
Service Provider        business) / residential address (for
...
5    Buyer’s           Telephone number            E-commerce platform provider to
Contact           of Merchant and/or          input the contact number of
Number            Service Provider            Merchant and/or Service Provider

6    Buyer’s SST       SST registration            Where applicable, e-commerce
Registration      number of Merchant          platform provider to input Merchant
Number            and/or Service              and/or Service Provider’s SST
...
7    Classification    Classification of           e-commerce platform provider to
products or services        input a 3-digit integer (e.g., “000” to
“999”), in accordance with the
catalogue set by IRBM
...
16. e-Invoice treatment during interim relaxation period

**16.1** To ensure the smooth transitioning and implementation of e-Invoice, the
Government of Malaysia has, on 26 July 2024, agreed to provide taxpayers
a six (6)-month interim relaxation period from the date of mandatory
implementation of each implementation phase, as follows:
...
Taxpayers with an annual turnover or revenue            1 August 2024 to
1.
of more than RM100 million                              31 January 2025

Taxpayers with an annual turnover or revenue
1 January 2025 to
2.   of more than RM25 million and up to RM100
30 June 2025
million

Taxpayers with an annual turnover or revenue
1 July 2025 to
3.   of more than RM5 million and up to RM25
31 December 2025
million

Taxpayers with an annual turnover or revenue
of up to RM5 million                                          Until
4.
i) 1 January 2026 implementation date                 31 December 2027
...
1    “EI00000000010” as       i. Individual’s (i.e., Supplier, Buyer, Shipping
General Public’s TIN         Recipient) TIN in the e-Invoice for Malaysian
...
2    “EI00000000020” as        i. Buyer’s TIN in the e-Invoice for non-Malaysian
Foreign Buyer’s /            individual where the individual buyer only
Foreign Shipping             provides passport number / MyPR / MyKAS
Recipient’s TIN              identification number
...
3    “EI00000000030” as        i. Supplier’s TIN in the e-Invoice for
Foreign Supplier’s TIN       non-Malaysian individual where the individual
...
4    “EI00000000040” as       Buyer’s TIN for transactions involving the following
Buyer’s TIN              persons:
•   Government
...
E-INVOICE
No      Data field      Details to be input             Additional Remarks
by Supplier in
e-Invoice
...
7    Description of     Details of products or     IRBM allows the Suppliers to
Product /          services being billed      adopt one (or a combination) of
Services           for a transaction with     the following methods:
customers                  (a) Summary of each receipt is
presented as separate line
items
...
1     Payment to agents,              Agents, dealers,         Taxpayer that makes
dealers, distributors, etc.      distributors, etc.           the payment

2     Goods sold or services            Foreign Seller         Malaysian Purchaser
rendered by foreign
suppliers
3     Profit distribution (e.g.,       Recipient of the        Taxpayer that makes
dividend distribution)              distribution            the distribution
...
5     Pay-out to all betting and    Recipient of the pay-      Licensed betting and
gaming winners                          out                 gaming provider


6     Transactions with                 Individual not        Person transacting with
individuals who are not       conducting a business        the individual not
conducting a business                                   conducting a business


7     Interest payment               Recipient of interest     Taxpayer that makes
...
## Appendix 4 – Buyer's Details for Transaction with Individuals
...
1    Buyer’s          Name of individual     For Malaysian individuals: Full name
Name             Buyer                  as per MyKad / MyTentera
...
4    Buyer’s         Address of               Individual Buyer is required to provide
Address         individual Buyer         residential address


5    Buyer’s         Telephone number         Individual Buyer is required to provide
Contact         of individual Buyer      a contact number
Number


6    Buyer’s SST     SST registration         Where applicable, Supplier to input
Registration    number of                SST registration number
Number          individual Buyer
...
## Appendix 5 – General and Industry-Specific FAQ
...
6.     Petroleum             https://www.hasil.gov.my/media/wwjb5sof/lhdnm_in
Operations            dustry-specific-faqs_petroleum-
operations_bi_v2.pdf

7.     Insurance and         https://www.hasil.gov.my/media/qpsncvwd/specific-
Takaful               faq-insurance-and-takaful.pdf
...
10.   Financial Services,   https://www.hasil.gov.my/media/acil1u20/specific-
Stockbroking, Unit    faq-financial-services-stockbroking-and-unit-
Trust and Money       trust.pdf
Changing Services

11.   Donations or          https://www.hasil.gov.my/media/sfmnjwgg/specific-
Contributions         faq-donations-or-contributions.pdf
