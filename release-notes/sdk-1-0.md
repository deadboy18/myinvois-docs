...
• To enhance data integrity, taxpayers will be required to comply with the validation rules for the following fields:
  ...
  g) **Unit of Measurement** must follow unit code stated **[here](../05-code-tables/unit-types.md)**.
...
• With reference to the release note issued on 1 August 2025, which specified the requirement to include the **[Currency Exchange Rate](../04-document-types/invoice-v1-0.md#core)** element when the Invoice Currency Code is not equal to MYR, please be advised of the following timeline:
...
• A rate limit has been added to the [Integration Practices FAQ](../01-getting-started/integration-practices.md#rate-limit) section.
