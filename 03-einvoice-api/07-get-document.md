...
| document | [Document](../04-document-types/README.md) | Document string containing the original submitted raw document. Document with 'invalid' status will not be returned. Details of the invalid document can be fetched by [Get Document Details](08-get-document-details.md) API. |  |
